 ...
 */
final class Version20240216101936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, statut_coursier VARCHAR(255) DEFAULT NULL, statut_client VARCHAR(255) DEFAULT NULL, date_livraison DATE NOT NULL, intervalle_temp TIME NOT NULL, prix DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
